...
extension String {
    ...
    public func withAttributes(_ attributes: [Attribute], targetStr: String) -> NSMutableAttributedString {
        let attributStr = attributedString
        attributStr.addAttributes(attributes, range: range(of: targetStr))
        return attributStr
    }
    ...
    public func withAttribute(_ attribute: Attribute, targetStr: String) -> NSMutableAttributedString {
        let attributStr = attributedString
        attributStr.addAttributes([attribute], range: range(of: targetStr))
        return attributStr
    }
...
extension String {
    ...
    public func withFont(_ font: Font, targetStr: String) -> NSMutableAttributedString {
        return withAttribute(.font(font), targetStr: targetStr)
    }

    public func withTextColor(_ color: Color, targetStr: String) -> NSMutableAttributedString {
        return withAttribute(.textColor(color), targetStr: targetStr)
    }
